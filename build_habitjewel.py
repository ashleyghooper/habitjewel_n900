...
chmod 755 /opt/habitjewel/habitjewel.py
    ...
    version = "0.2.9"           #Version of your software, for example "1.2.0" or "0.8.2"
    ...
    changeloginformation = "Layout improvements, master habits list, habit deletion/undeletion, pause/unpause"
