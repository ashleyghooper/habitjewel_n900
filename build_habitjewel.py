...
chmod 755 /opt/habitjewel/habitjewel.py
    ...
    version = "0.7.1"          #Version of your software, for example "1.2.0" or "0.8.2"
    ...
    changeloginformation = """[0.7.1] - 2016-09-13
...
- Moved change log from main script to CHANGELOG.md
"""
